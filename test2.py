...
class ProxyConfig:
	...
	local_port: int = 1080
	remote_addr: str = "iplc-b15-hk-1.tr202512.com"
	remote_port: int = 7001
	password: str = "kQAnChGvV8D8kSV6wM"
	verify: bool = True
...
class ProxyHttpClient:
	def __init__(self, proxy_config: ProxyConfig, timeout: int = 30) -> None:
		self.proxy_config = proxy_config
		self.timeout = timeout
